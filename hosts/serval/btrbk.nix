...
in {
  ...
  # over SSH to pi@beacon:/mnt/btrfs-backup/serval.
  # Docs: https://digint.ch/btrbk/doc/btrbk.conf.5.html
  #
  # One-time setup (serval):
  #   sudo install -d -m 700 /etc/btrbk/ssh
  #   sudo ssh-keygen -t ed25519 -N "" -f /etc/btrbk/ssh/id_ed25519 -C btrbk@serval
  ...
  #   # Append serval's pubkey to /home/pi/.ssh/authorized_keys, prefixed with:
  ...
  services.btrbk.instances."btrbk" = {
    ...
    settings = {
      ...
      # Local snapshots on serval / remote backups on beacon
