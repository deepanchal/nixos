...
# and in the NixOS manual (accessible by running ‘nixos-help’).
{
  ...
  imports = [
    ...
    (import ./disk-config.nix {device = "/dev/disk/by-id/nvme-Samsung_SSD_9100_PRO_4TB_S7YANJ0Y514813N";})
  ...
  boot = {
    ...
    kernelParams = [
      ...
      # Required for the NVIDIA dGPU + Wayland (PRIME offload)
  ...
  ##################################################
  networking = {
    hostName = "serval"; # Define your hostname.
