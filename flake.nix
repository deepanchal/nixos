...
# - https://github.com/fufexan/dotfiles
{
  ...
  in {
    ...
    hyprland = {
      # url = "github:hyprwm/Hyprland?ref=v${hyprlandVersion}"; # where {version} is the hyprland release version
      url = "github:hyprwm/Hyprland"; # to follow the development branch
      inputs.nixpkgs.follows = "nixpkgs";
    };
    hy3 = {
      # url = "github:outfoxxed/hy3?ref=hl${hyprlandVersion}"; # where {version} is the hyprland release version
